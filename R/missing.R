...
#' @param bed a list of lazyframes
#' @param ref path to file of reference CpG sites
#' @param blacklist path to file of excluded CpG sites
#' @returns a list of lazyframes
#' @examples align_to_reference(bedfile, reference, excluded)
#' @keywords internal
#' @noRd 
#' @import polars
...
#' @param ref path to file of reference CpG sites
#' @param blacklist path to file of excluded CpG sites
#' @param mincov numeric value of minimum coverage threshold
#' @param ml boolean; whether to use machine learning or not
#' @returns a list of lazyframes
#' @examples missing_sites(bedfile, reference, excluded, 10, FALSE)
#' @keywords internal
#' @noRd 
#' @import polars
